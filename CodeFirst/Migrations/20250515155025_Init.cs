    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "jan.kowalski@nfz.gov.pl", "Jan", "Kowalski" },
                    { 2, "andrzej.nowak@nfz.gov.pl", "Andrzej", "Nowak" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Very stronk medicament", "Medicament Uno", "Type Uno" },
                    { 2, "Very weak medicament", "Medicament Dos", "Type Dos" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(1995, 5, 12), "Wojciech", "Nowak" },
                    { 2, new DateOnly(1997, 2, 26), "Mariusz", "Kowalski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2025, 5, 14), new DateOnly(2025, 5, 24), 2, 1 },
                    { 2, new DateOnly(2025, 5, 7), new DateOnly(2025, 5, 24), 1, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Take doses in the morning.", 2 },
                    { 2, 1, "Take doses after dinner.", 1 }
                });
